        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I build performant React Native and React applications with
                production-ready architecture, clean UI implementation, and
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DELIVER</h3>
              <h4>Team Collaboration & Optimization</h4>
              <p>
                I collaborate with QA, backend, PM, and UI teams to deliver
                features on time, refactor codebases, and improve app
